        ...
        <div class="container mx-auto  px-4 sm:px-8">
            <div class="py-8">
                <div>
                    ...
                    <div class="flex leading-5"><router-link style="display: inline-flex;" to="/explore/siswa-add">
                            ...
                            <div class="flex leading-5"><router-link style="display: inline-flex;"          :to="{ name: 'KelasView'}">
                                &nbsp;&nbsp;&nbsp;&nbsp;  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-save w-5 h-5 mr-1">
                                <path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path>
                            ...
                            Tabel Kelas</router-link></div><div class="flex leading-5"><router-link style="display: inline-flex;"       :to="{ name: 'KelasAdd'}">
                                &nbsp;&nbsp;&nbsp;&nbsp;  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-save w-5 h-5 mr-1">
                                <path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path>
                            ...
                            <tbody>
                                <tr v-for="siswas in siswa" :key="siswas._id">
                                    ...
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <div class="contents">
                                            <div class="flex-1 ...">
                                                <div class="mb-2"><button @click="deleteAccount(siswas._id)"
                                                        type="submit"
                                    ...
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <div class="contents">
                                            <div class="flex-1 ..."> 
                                                <router-link :to="`/explore/siswa-spp/${siswas._id}`" class="mb-2"><button
                                                        class="px-5 py-3 rounded-xl text-sm font-medium text-gray-100 bg-pink-800 outline-none border text-gray-300 focus:outline-none bg-gray-100 m-1 hover:m-0 focus:m-0 border text-pink-600 hover: bg-gray-100 border-4 focus:border-4 hover:border-800 hover:text-pink-800 focus:border-pink-200 active:border-pink-900 active:text-grey-900 transition-all">
                                                        <a class="text-gray-100">Edit SPP</a>
                                                        <i
                                                            class="mdi mdi-circle-outline ml-2 text-xl align-middle leading-none"></i>
                                                    </button>
                                                </router-link>
