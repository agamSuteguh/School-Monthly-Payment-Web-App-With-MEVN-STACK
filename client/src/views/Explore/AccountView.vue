  ...
  <div class="pb-3">
    <div class="account-page bg-gray-900 pb-12 mb-12">
      <div class="account flex py-12 justify-center items-center">
        <div
          class="account-img outline outline-offset-1 outline-blue-500 shadow-lg shadow-pink-500/40 w-44"
        >
          <img
            class="w-full object-cover rounded bg-gray-200"
            :src="`https://avatars.dicebear.com/api/bottts/${account.fullname}.svg`"
            alt=""
          />
        </div>
        <div class="account-content text-gray-100 ml-4">
          ...
          <div class="mt-4 px-2 py-1">
            <select class="bg-gray-500" v-model="account.gender">
              <option :selected="account.gender === 'Wanita'" value="Wanita">
                Wanita
              </option>
              <option :selected="account.gender === 'Pria'" value="Pria">
                Pria
              </option>
            </select>
          </div>
